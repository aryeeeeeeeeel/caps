...
const Dashboard: React.FC = () => {
  ...
  const quickActions: QuickAction[] = [
    {
      ...
      icon: warningOutline,
      route: '/it35-lab2/app/home/submit',
      color: '#ef4444'
    },
    {
      title: 'View Map',
      description: 'See hazard locations',
      icon: mapOutline,
      route: '/it35-lab2/app/home/map',
      color: '#3b82f6'
    },
    {
      title: 'My Reports',
      ...
      icon: eyeOutline,
      route: '/it35-lab2/app/home/reports',
      color: '#10b981'
    },
    {
      title: 'Notifications',
      ...
      route: '/it35-lab2/app/home/notifications',
      color: '#f59e0b'
    }
  ];
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      // Fetch weather info (mock for development)
      setWeatherInfo({
        temperature: '28°C',
